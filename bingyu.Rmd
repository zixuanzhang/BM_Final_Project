...
cancer_county =
  ...
  gather(key = covariate, value = value, -county) %>% 
  mutate(covariate = str_replace_all(covariate, c("pct_no_hs18_24" = "pct_hs", "pct_hs18_24" = "pct_hs", "pct_hs25_over" = "pct_hs", "pct_bach_deg18_24" = "pct_col", "pct_bach_deg25_over" = "pct_col"))) %>% 
  group_by(county, covariate) %>% 
