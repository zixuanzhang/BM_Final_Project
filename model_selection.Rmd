...
criterion_model_low <- lm(formula = target_death_rate ~ incidence_rate + poverty_percent + 
...
criterion_model_high <- lm(formula = target_death_rate ~ incidence_rate + poverty_percent + 
    median_age_female + pct_unemployed16_over + pct_black + pct_other_race + pct_upto_hs18_24, 
